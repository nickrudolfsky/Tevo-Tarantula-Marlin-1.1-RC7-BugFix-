...
#define STRING_CONFIG_H_AUTHOR "(Ron de Leos, TEVO Tarantula config v2)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //#define  DEFAULT_bedKd 1675.16
	...
	// TEVO Tarantula Custom PID Settings - Large Heatbead with Insulation
    #define  DEFAULT_bedKp 44.06
    #define  DEFAULT_bedKi 7.37
    #define  DEFAULT_bedKd 65.87
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {79.84,79.79,1608.57,95.5}  // custom steps per unit for Tarantula w/E3D Titan Extruder
//#define DEFAULT_MAX_FEEDRATE          {300, 300, 5, 25}    // (mm/sec)
#define DEFAULT_MAX_FEEDRATE          {300, 300, 5, 100}    // (mm/sec) custom for TEVO Tarantula
//#define DEFAULT_MAX_ACCELERATION      {3000,3000,100,10000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
#define DEFAULT_MAX_ACCELERATION      {2000,2000,100,10000}    // Custom for TEVO Tarantula

//#define DEFAULT_ACCELERATION          3000    // X, Y, Z and E acceleration in mm/s^2 for printing moves
#define DEFAULT_ACCELERATION          2000    // Custom for TEVO Tarantula
#define DEFAULT_RETRACT_ACCELERATION  3000    // E acceleration in mm/s^2 for retracts
#define DEFAULT_TRAVEL_ACCELERATION   3000    // X, Y, Z acceleration in mm/s^2 for travel (non printing) moves

// The speed change that does not require acceleration (i.e. the software might assume it can be done instantaneously)
//#define DEFAULT_XYJERK                20.0    // (mm/sec)
#define DEFAULT_XYJERK                10.0    // (mm/sec) Custom for TEVO Tarantula
#define DEFAULT_ZJERK                 0.39     // (mm/sec)
